...
<body class="antialiased">
    <div
        ...
        <!-- Add a button for incrementing the number -->
        <button id="increment-button"
            class="mt-4 px-4 py-2 bg-blue-500 text-white rounded-md focus:outline-none">Increment</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Add an event listener to the button for incrementing the number
            ...
            // Add an event listener to the button for resetting the number
            document.getElementById('reset-button').addEventListener('click', function () {
                // Reset the generated number to 0
                generatedNumber = 0;
